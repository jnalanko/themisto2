...
/usr/bin/time -v themisto2 build -s sbwt/unitigs.sbwt -i fof/unitigs.txt -o index/unitigs.thm2 --temp-dir temp -k 31 -d 30 -t 32 --index-type sparse-dense --from-unitigs 2>&1 | tee logs/unitigs.log

/usr/bin/time -v themisto2 build -s sbwt/unitigs-half1.sbwt -i fof/unitigs-half1.txt -o index/half1.thm2 --temp-dir temp -k 31 -d 30 -t 32 --index-type sparse-dense --from-unitigs 2>&1 | tee logs/half1.log

/usr/bin/time -v themisto2 build -s sbwt/unitigs-half2.sbwt -i fof/unitigs-half2.txt -o index/half2.thm2 --temp-dir temp -k 31 -d 30 -t 32 --index-type sparse-dense --from-unitigs 2>&1 | tee logs/half2.log
...
# Fulgor
# ~/code/fulgor/build/fulgor build -l fof/unitigs.txt -o index/unitigs -k 31 -m 20 -d temp -g 48 -t 32 --verbose
# ~/code/fulgor/build/fulgor dump -i index/unitigs.fur -o export/fulgor
